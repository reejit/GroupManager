...
I am a modular group manager bot.

Made with python by [The Checked Plugins](t.me/checkedplugins)

Ask my commands to [them](t.me/askplugins)
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("I'm ❤️zinda❤️")
